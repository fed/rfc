...
In order to propose an ADR, first open an issue to circulate the fundamental
idea for initial feedback. It should generally be
...
Source: https://github.com/straw-hat-team/adr/blob/main/src/adrs/0000000000/README.md
